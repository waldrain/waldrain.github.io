...
- [Solar panel](#solar-panel): mounting, connecting, cables, diodes
...
<center>
<img src="/doc/pv/2025-07-30_pvm_sketch.jpg" alt="PVM" title="PVM" width="90%"/>
</center>

<!--
energy generated by east facing panels in year 2022:
2022-01-30 E 41.9 kWh
2022-12-30 E 232 kWh
2023-01-21 E 235 kWh
235 - 50 = 185 kWh with 400 Wp
-->
...
Due to the different panel orientations, neither of the first two can ever reach their theoretical peak performance.
...
/Users/jta/j/src/arduino/pv_load_switcher/log/

2023-10-02_14.48.51.comm
2023-10-05_07.32.59.comm

/Users/jta/j/src/arduino/pv_load_switcher/xls/

2023-10-02_14.48.51.comm.xlsx
2023-10-05_07.32.59.comm.xlsx

-->

The sudden dips in the battery voltage indicate when the [hot-water heatpump](moniwonig#wwwp) (ca. 500W) and the milk foamer (800W) are turned on.
...
Presumably, this was caused by the cell voltages drifting too far apart.
...
the [aussenkueche](moniwonig/#aussenkueche):
...
2026-08-15 3-phase balkonkraftwerk on south half using 6 panels a 1134 x 1724 x 30 mm:
roof tile size is 225 x 336 mm;
...
width in cm = horizontal rail length is 120 = 3 + 114 + 3 for one, 237 = 3 + 114 + 3 + 114 + 3 for two, and 354 for 3 panels;
corresponding tile widths are 5.33 = 1200/225, 10.53 = 2370/225, and 15.73 = 3540/225;
do we have 16 x 11 tiles free space in the south-east corner of the roof?
...
To select a suitable wire gauge and cable size, please refer to
...
### EVE LiFePO4 3.2V 280Ah

EVE LiFePO4 16S LF280K 3.2V 280Ah: 
...
V<sub style="font-size:75%">B</sub> was 25.9 before turning on the inverter, 25.5 afterwards.
...
E 230 kWh 28.0V 0.8A / 26.5V  0.8A load 27.0 kWh;
S 13Ah 72V / 26.4V  2.3A,
V 13Ah 40V / 26.3V  3.3A
...
2023-01-03 11:30 moderately cloudy
E 233 kWh 28.0V 0.2A / 26.4V -0.1A load 0.3 A 28.5 kWh    W;
S  4Ah 73V / 26.3V  1.7A    W;
V  4Ah 41V / 26.1V  1.7A    W;
B 259.8
C 809.4
H 674.15
G 68.5
...
2023-02-08 14:00 in full sunshine: 4 + 12 + 19 = 35 A --> 875 W with 650 W load
...
2023-04-10 22:20: 26.8V before turning on boiler, 26.3V afterwards, with 600W extra load
C 937.7
G 129.3
E 257 kWh 28.0V 0.0A /   . V  0. A load 0.  A 33.1 kWh    W;
S 52Ah
...
2024-12-04 15:40 cloudy, about to install new batteryand jk bms; cell 4 is way off:
cells: 3.29 + 3.31 + 3.31 + 2.77 + 3.11 + 3.31 + 3.31 + 3.28 = 25.69

### Meter Readings Summer 2023

- wwwp zaehler PV G (moniwonig grid mains) WWWP
  2023-05-28         6.0 152.3  35.4
  2023-06-02 14:00  17.6 159.0  45.4
  2023-06-03  9:00  18.9 159.4  45.8
  2023-06-04        21.0 161.6  48.0
  2023-06-08 16:30  29.3 169.7  55.9
  2023-08-26 12:00 169.4 232.7    --
  2023-08-28 09:00 171.4 235.1 169.7
  2023-08-29 17:00 172.8 236.6 170.7
  2023-08-31 08:20 175.2 240.2 174.2
  2023-08-31 17:00 176.3 240.2 175.0
  2023-09-02 12:50 179.5 242.1 178.7
  2023-09-02 15:10 180.6 242.1 179.8
  2023-09-03 12:40 181.4 242.5 179.9
  2023-09-03 20:00 183.1 242.5 181.4
  2023-09-04 12:20 183.9 242.5 181.4
  2023-09-04 17:10 186.5 242.8 184.0
  2023-09-05 12:20 187.1 242.9 184.1
  2023-09-05 17:50 189.8 243.2 186.8
  2023-09-06 17:10 192.6 243.2 188.7
  2023-09-07 12:00 193.5 243.3 188.7
  2023-09-07 17:00 195.8 243.3 190.9
  2023-09-08 12:10 198.5 243.4 193.3
  2023-09-13 14:20 211.9 245.6 202.0
  2023-09-14 17:20 214.6 245.7 203.7
  2023-09-15 11:20 215.4 245.7 203.7
  2023-09-18 17:00 223.9 247.4 210.2
  ...
  2023-10-06 08:30 266.1 262.8 247.1 pv 0.6 grid 1.4 wwwp 1.3 to heat from 38 degrees to 47 degrees in 3.0 hours overnight
  2023-10-06 19:00 268.5 264.1 249.1 pv 2.4 grid 1.3 wwwp 2.0 to heat from 46 degrees to 60 degrees in 4.0 hours
